...
import com.pafoid.skate.editor.systems.*
import com.pafoid.skate.editor.windows.project.FileType
...
class ProjectWindow : IWindow, KoinComponent {
    ...
    private fun handleInlineInput() {
        ...
        creatingInPath?.let { path ->
            ...
            if (isKeyPressed(org.lwjgl.glfw.GLFW.GLFW_KEY_ENTER) || enterPressed) {
            ...
            if (isKeyPressed(org.lwjgl.glfw.GLFW.GLFW_KEY_ESCAPE)) {
                creatingInPath = null
            }
            popItemWidth()
            popID()
