...
data class SceneOpenSucceeded(val scene: Scene) : SceneAction("scene.action.open_succeeded")
object SceneOpenCancelled : SceneAction("scene.action.open_cancelled")
data class SceneOpenFailed(val reason: String) : SceneAction("scene.action.open_failed")
