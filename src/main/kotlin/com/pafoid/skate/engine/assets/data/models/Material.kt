...
data class Material(
    ...
    @Contextual val baseColor: Vector4f = Vector4f(1f, 1f, 1f, 1f),
    @Contextual val baseColorFactor: Vector4f = Vector4f(1f, 1f, 1f, 1f),
    var metallicFactor: Float = 0f,
    var roughnessFactor: Float = 0.5f,
    @Contextual val emissiveFactor: Vector3f = Vector3f(0f, 0f, 0f),
