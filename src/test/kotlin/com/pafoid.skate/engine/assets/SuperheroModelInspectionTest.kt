...
class SuperheroModelInspectionTest {

    @Test
    fun `inspect superhero dimensions`() {
        val loader = AssimpLoader()
        val filePath = "assets/characters/Superhero_Male_FullBody.gltf"
        ...
        println("Bounding Box (after 6.0 scale):")
