...
| AUD-007 | Project switch/open lifecycle may leave stale scene/resource state | High | Project lifecycle | in_progress | software-engineer | `src/main/kotlin/com/pafoid/skate/editor/imgui/ImGuiLayer.kt`, `src/test/kotlin/com/pafoid/skate/editor/imgui/ImGuiLayerStartupFlowTest.kt`, `src/main/kotlin/com/pafoid/skate/editor/systems/ProjectManager.kt`, `src/main/kotlin/com/pafoid/skate/engine/ecs/SceneManager.kt` |
