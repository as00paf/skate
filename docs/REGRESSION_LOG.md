...
| AUD-004 | File operations use weak success handling (`renameTo/create/delete`) | High | Filesystem commands | open | software-engineer | `src/main/kotlin/com/pafoid/skate/editor/commands/project/{CreateFileCommand,RenameFileCommand,DeleteFileCommand}.kt` |
| AUD-005 | Undo of created directory may remove user-added files | High | Undo/Redo safety | open | software-engineer | `src/main/kotlin/com/pafoid/skate/editor/commands/project/CreateFileCommand.kt` |
