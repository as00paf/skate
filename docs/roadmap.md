...
| A46.0.1 | Comprehensive Engine UI & Editor Tooling Revamp  | 2     | High     | Render Graph baseline                         | In Progress | Subtasks 1, 2, 4 complete (Console, Profiler, Toolbar, Search, History). Remaining: context menus and drag/drop (subtask 3). |
