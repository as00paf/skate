...
|---------|--------------------------------------------------|-------|----------|-----------------------------------------------|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A48.0.2 | Editor/Engine Separation Refactor (Main.kt-down) | 2     | Critical | A48.0.1, tech-lead architecture approval gate | In Progress | Re-establish hard engine/editor boundaries, starting explicitly with `Main.kt`, `Engine.kt`, `Window.kt`, `ImGuiLayer.kt`, `EditorWorkspace.kt`, then widen to package-level cleanup and guard tests. |
