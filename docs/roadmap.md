...
|---------|--------------------------------------------------|-------|----------|-----------------------------------------------|-----------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A48.0.2 | Editor/Engine Separation Refactor (Main.kt-down) | 2     | Critical | A48.0.1, tech-lead architecture approval gate | In Progress (P2/P3 complete 2026-06-14) | Re-establish hard engine/editor boundaries. DI decomposition (P2) and engine package decontamination (P3) completed; next phases: move remaining editor-only systems (P4), add layering guard tests (P5), and reconcile docs (P6). |
| A46.0.1 | Comprehensive Engine UI & Editor Tooling Revamp  | 2     | High     | Render Graph baseline                         | Closed                                  | All 4 subtasks complete and reviewed (2026-05-31).                                                                                                                                                                                 |
