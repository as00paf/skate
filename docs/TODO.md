...
- `[in_progress]` `REG-018` - Reproduce and isolate skater runtime failures in Play mode (gravity, gamepad movement, animation)  
  **Owner:** `qa-engineer`  
  **Outcome:** reproducible scenario + expected/actual matrix to unblock implementation tasks.

## Queued (Do Not Start Yet)

- `[pending]` `REG-019` - Restore gravity influence on skater runtime body (`physics-engineer`)
- `[pending]` `REG-020` - Restore gamepad-driven movement flow (`software-engineer`)
- `[pending]` `REG-021` - Restore runtime animation state transitions (`software-engineer`)
- `[pending]` `REG-022` - End-to-end runtime validation (`qa-engineer`)
## Skater Runtime Recovery - Ordered Work Queue

- `[in_progress]` `REG-018` - Runtime repro + failure isolation (`qa-engineer`)
- `[pending]` `REG-019` - Gravity restoration (`physics-engineer`)
- `[pending]` `REG-020` - Gamepad movement restoration (`software-engineer`)
- `[pending]` `REG-021` - Runtime animation restoration (`software-engineer`)
- `[pending]` `REG-022` - End-to-end validation (`qa-engineer`)

Rule: start the next item only after the current item is marked `resolved`.
- `[in_progress]` `REG-018` execution brief issued: `docs/REG-018_QA_EXECUTION.md` (owner: `qa-engineer`)
- `[ready]` `REG-019` execution packet: `docs/REG-019_PHYSICS_EXECUTION.md`
- `[ready]` `REG-020` execution packet: `docs/REG-020_INPUT_EXECUTION.md`
- `[ready]` `REG-021` execution packet: `docs/REG-021_ANIMATION_EXECUTION.md`
- `[ready]` `REG-022` execution packet: `docs/REG-022_QA_VALIDATION_EXECUTION.md`
- `[blocked]` `REG-018` - QA runtime repro execution is blocked by unavailable runtime/test execution tooling in current environment.

## 2026-05-04 Status Update

- `[done]` `REG-018` - Runtime repro/isolation completed and fed into REG-019..REG-021 fixes
- `[done]` `REG-019` - Gravity/runtime rigid-body registration restoration
- `[done]` `REG-020` - Gamepad runtime input flow restoration
- `[done]` `REG-021` - Runtime animation transition restoration
- `[done]` `REG-022` - Integrated validation package (focused end-to-end automated checks)
