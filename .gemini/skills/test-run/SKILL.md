...
```powershell
.\gradlew.bat test --tests "com.pafoid.skate.engine.physics.SkateboardPhysicsTest"
```

### Run a Specific Test Method

```powershell
.\gradlew.bat test --tests "com.pafoid.skate.engine.physics.SkateboardPhysicsTest.applyTailImpulse_StationaryOnGround_NoseMovesUpward"
```

### Run All Tests in a Package

```powershell
.\gradlew.bat test --tests "com.pafoid.skate.engine.physics.*"
```
...
```powershell
.\gradlew.bat test --tests "com.pafoid.skate.path.to.FailingTest"
```
